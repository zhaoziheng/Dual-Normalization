...
--pred_label_dir '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/Dataset992_CHAOSMR_T2SPIR_PNG/labelsPred_from_DualNorm_CHAOSMR_T2SPIR' \
--visual_label_dir '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/Dataset992_CHAOSMR_T2SPIR_PNG/visual_from_DualNorm_CHAOSMR_T2SPIR' \
--gt_label_dir '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/Dataset992_CHAOSMR_T2SPIR_PNG/labelsTs_from_DualNorm_CHAOSMR_T2SPIR' \
--batch_size 32 \
--gpu_ids 0
...
--test_domain_list '' \
--model_dir '/mnt/petrelfs/zhaoziheng/Knowledge-Enhanced-Medical-Segmentation/Dual-Normalization/results/CHAOSMR_T2SPIR/model' \
--pred_label_dir '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/Dataset991_CHAOSMR_T1_PNG/labelsPred_from_DualNorm_CHAOSMR_T2SPIR' \
--visual_label_dir '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/Dataset991_CHAOSMR_T1_PNG/visual_from_DualNorm_CHAOSMR_T2SPIR' \
--gt_label_dir '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/Dataset991_CHAOSMR_T1_PNG/labelsTs_from_DualNorm_CHAOSMR_T2SPIR' \
--batch_size 32 \
--gpu_ids 0
...
# --visual_label_dir '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/Dataset989_LiQA_GED4_PNG/visual_from_DualNorm_CHAOSMR_T2SPIR' \
# --gt_label_dir '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/Dataset989_LiQA_GED4_PNG/labelsTs_from_DualNorm_CHAOSMR_T2SPIR' \
# --batch_size 32 \
# --gpu_ids 0
...
# --visual_label_dir '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/Dataset985_ATLAS_T1CE_PNG/visual_from_DualNorm_CHAOSMR_T2SPIR' \
# --gt_label_dir '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/Dataset985_ATLAS_T1CE_PNG/labelsTs_from_DualNorm_CHAOSMR_T2SPIR' \
# --batch_size 32 \
# --gpu_ids 0
...
# --visual_label_dir '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/Dataset950_AMOS22CT_PNG/visual_from_DualNorm_CHAOSMR_T2SPIR' \
# --gt_label_dir '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/Dataset950_AMOS22CT_PNG/labelsTs_from_DualNorm_CHAOSMR_T2SPIR' \
# --batch_size 32 \
# --gpu_ids 0
