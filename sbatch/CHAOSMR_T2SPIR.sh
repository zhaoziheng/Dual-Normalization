...
# --input_image_dir '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/Dataset992_CHAOSMR_T2SPIR_PNG/imageTs_from_DualNorm_CHAOSMR_T2SPIR' \
# --batch_size 32 \
# --gpu_ids 0
...
# --input_image_dir '/mnt/hwfile/medai/zhaoziheng/SAM/nnUNet_data/nnUNet_raw/Dataset991_CHAOSMR_T1_PNG/imageTs_from_DualNorm_CHAOSMR_T2SPIR' \
# --batch_size 32 \
# --gpu_ids 0
